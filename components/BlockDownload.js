      ...
      <SbEditable content={blok}>
         <span className="block mt-8 mb-16 border border-gray-200 rounded-md shadow-lg">
            <span className="flex flex-col p-8 md:block md:clear" >
               <Link href={blok.link}>
                  <a target="_blank" className="order-2 w-full px-4 py-2 font-bold text-center text-white rounded-md md:float-right md:w-auto md:px-8" style={{ backgroundColor: blok.background_color.color}}>
                     Afficher le dossier
                  </a>
               </Link>
